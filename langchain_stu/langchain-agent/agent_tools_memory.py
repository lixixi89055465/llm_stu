...
# {'input': '你好，我的名字是cyber', 'chat_history': [], 'output': '你好，Cyber，很高兴认识你！我能帮助你什么呢？'}
from langchain_core.messages import AIMessage,HumanMessage
response=agent_executor.invoke(
    {
        'chat_history':[
            HumanMessage(content='Hi,我的名字是Jack'),
            AIMessage(content='你好，jack,很高兴见到你！有什么我可以帮助你的码？')
        ],
        'input':'我的名字是什么?'
    }
)
...
print(response)
# {'chat_history': [HumanMessage(content='Hi,我的名字是Jack', additional_kwargs={}, response_metadata={}),
# AIMessage(content='你好，jack,很高兴见到你！有什么我可以帮助你的码？', additional_kwargs={}, response_metadata={})],
# 'input': '我的名字是什么?', 'output': '你的名字是Jack。'}
