...
{'input': '猫的特征?今天上海天气怎么样?', 'output': '### 猫的特征：\n猫是典型的小型哺乳动物，其主要特征包括：\n- **身体形态**：体型小巧，身长0.3-0.5米，体色多样，包括黄、黑、白、灰等。猫的四肢较短，足下有脂肪质肉垫，行走无声。\n- **面部表情**：有26种独特面部动作，如瞳孔变化、耳朵位置变化、舔鼻子等。\n- **牙齿结构**：成年猫有30颗牙齿，牙齿分为门齿、犬齿和臼齿，犬齿尖锐适于捕食。\n- **行为特点**：攀爬能力强，喜欢独居且有领地意识。\n\n猫毛发柔软，部分品种如无毛猫则无毛披覆，它也是人类喜爱的伴侣宠物，性格活泼、聪明、机敏。[详情链接](https://zh.wikipedia.org/wiki/猫)\n\n---\n\n### 今天上海的天气：\n- 实况：**晴，24°C**, 湿度41%，西北风1级。\n- 白天：多云，最高气温**26°C**。\n- 夜间：阴，最低气温**19°C**。\n\n天气偏凉，建议穿着单衣单裤，年老体弱者可加件贴身背心。[详情链接](https://tianqi.moji.com/today/china/shanghai/shanghai)'}
